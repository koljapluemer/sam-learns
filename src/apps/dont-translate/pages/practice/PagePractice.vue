...
import { getLanguages, type Language } from '../../entities/flashcard/flashcard'
import PracticeSession from './PracticeSession.vue'

const languageCode = useLocalSetting('dont-translate.language', '')
const languages = ref<Language[]>([])
const setupOpen = ref(false)

useActiveTime('dont-translate')
