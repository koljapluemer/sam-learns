// Verbatim port of linguanodon's viettonepractice app/dailyChart.js.
...
export function toDate(day: string): Date | null {
...
export const getChartMinWidth = (count: number): string => `${Math.max(count * 56, 320)}px`
