// Vietnamese language pack. The distractor generator is ported unchanged
// from linguanodon's viettonepractice app/model.js (itself a tone-only port
// of listen-to-viet's src/entities/listening-clip/model.ts) - it mutates a
// single diacritic directly in the transcript, since Vietnamese orthography
// already visually marks tone.
...
export const vietPack: LanguagePack = {
  code: 'vie',
  name: 'Vietnamese',
  audioBaseUrl: '/data/minimal-pairs-practice/vie/audio/',
  clipsUrl: '/data/minimal-pairs-practice/vie/clips.json',
  toneKeys: TONE_KEYS,
  toneLabels: TONE_LABELS,
  credits: {
    datasetName: 'FPT Open Speech Dataset (FOSD) - Vietnamese',
    datasetUrl: 'https://data.mendeley.com/datasets/k9sxg2twv4/4',
    licenseName: 'CC BY 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
    licenseSummary: 'Creative Commons Attribution 4.0 - free to use, including commercially, with attribution.'
  },
