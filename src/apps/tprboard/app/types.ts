// Domain types ported from linguanodon's tprboard/static/tprboard/js/types.d.ts.

export type RelationshipEffect = 'NOTHING' | 'RETURN' | 'DISAPPEAR' | 'DESTRUCT' | 'WIGGLE' | 'HELD'
